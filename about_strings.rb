...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # The plus equals operator creates a new string. The shovel operator
    # does not create a new string but modifies the existing one so it 
    # is preferable from a performance view.
    #
  end
