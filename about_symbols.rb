...
class AboutSymbols < EdgeCase::Koan
  ...
  #
  # Checking that:
  #   all_symbols.include?(:test_method_names_becomes_symbols)
  # Would always be true because we would be creating the symbol we're looking for.
  ...
  #
  # Once created symbols are not unloaded from memory until the program ends.
end
